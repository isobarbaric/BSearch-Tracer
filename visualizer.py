...
class Pathfinder:
    ...
    def __init__(self):
        ...
        Block.block_width = (Pathfinder.window_size - (self.sz + 1) * Block.wall_width)/self.sz
    ...
    def draw_path(self, WINDOW):
        ...
        for elem in self.generate_path():
            ...
            self.blocks[elem[0]][elem[1]].draw(WINDOW, (87, 230, 97))
    ...
    def run(self):
        ...
        WINDOW = pygame.display.set_mode((Pathfinder.window_size, Pathfinder.window_size))
